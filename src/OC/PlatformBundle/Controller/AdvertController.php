...
class AdvertController extends Controller
{
    ...
    {
        if ($page < 1) {
            throw $this->createNotFoundException("La page ".$page." n'existe pass.");
        }
    ...
    public function purgeAction($days)
    {
        ...
        $this->addFlash('info', 'Les annonces sans candidature et plus anciennes que'.$days.' jours ont été purgées.');
